...
are working with — `draw_sprite`, `was_key_pressed`, `noise_2d`,
...
- @subpage page_utilities — math, rects, timers, random numbers and noise
- @subpage page_logging_and_data — logging, asserts and json files
