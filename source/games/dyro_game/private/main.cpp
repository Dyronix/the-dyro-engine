...
//   run.bat -game=dyro_game -window_width=1920 -window_height=1080
...
int main(int argc, char** argv)
{
	...
	settings.window_title = arguments.get("window_title", std::wstring(L"DyroEngine - demo game"));
	...
	{
		dyro::log::warn("unknown or invalid setting '{}' ignored", name);
	}
